...
// --- test-app/src/pages/Settings.tsx ---
    ...
    return (<div style={{
      ...
      <div style={{
        ...
        },
        {
            ...
            <input type={type} value={settings[key]} onChange={(e)=>setSettings((s)=>({
                    ...s,
                    [key]: e.target.value
                }))} style={{
            width: '100%',
        ...
        color: '#374151',
        marginBottom: '4px'
    }}>Chunking Strategy (Wundler)</label>
          <select value={settings.chunkingStrategy} onChange={(e)=>setSettings((s)=>({
                ...s,
        ...
        cursor: 'pointer'
          ...
          <input type="checkbox" checked={settings.notifications} onChange={(e)=>setSettings((s)=>({
                ...s,
        ...
        fontSize: '14px',
        color: '#374151'
    }}>Enable build notifications</span>
        </label>
