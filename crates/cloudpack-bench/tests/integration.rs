...
//! Integration tests for cloudpack-bench.
//!
...
use cloudpack_bench::synthetic::SyntheticApp;
...
fn test_abs_delta_correct() {
    use cloudpack_bench::abs_bench::{compute_delta, snapshot_from_disk};
...
fn test_report_formats_correctly() {
    use cloudpack_bench::cas_bench::CasBenchResult;
    use cloudpack_bench::abs_bench::AbsChurnResult;
    use cloudpack_bench::report::{format_cas_table, format_abs_table};
...
fn test_analysis_bench_run_returns_results() {
    use cloudpack_bench::analysis_bench;
...
fn test_extrapolate_linear_projection() {
    use cloudpack_bench::analysis_bench::{extrapolate, AnalysisBenchResult};
...
fn test_abs_run_scales_returns_one_entry_per_scale() {
    use cloudpack_bench::abs_bench::run_scales;
...
fn test_format_analysis_table_has_header_and_speedup() {
    use cloudpack_bench::analysis_bench::AnalysisBenchResult;
    use cloudpack_bench::report::format_analysis_table;
...
fn test_format_real_world_scenarios_contains_sections() {
    use cloudpack_bench::analysis_bench::AnalysisBenchResult;
    use cloudpack_bench::abs_bench::{AbsChurnResult, AbsScaleResult};
    use cloudpack_bench::report::format_real_world_scenarios;
