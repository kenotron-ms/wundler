//! Unit tests for `wundler_pipeline::build_id`.
//!
//! Acceptance: `cargo test -p wundler-pipeline --test build_id_test`
...
use wundler_pipeline::build_id::{canonical_bytes, compute_build_id};
