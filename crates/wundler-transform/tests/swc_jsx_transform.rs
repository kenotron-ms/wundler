...
//! `React.createElement` calls by `transform_ts_to_js`.

use wundler_transform::swc_util::transform_ts_to_js;

/// A `.tsx` file with a JSX element should emit `React.createElement` and
/// contain no raw JSX angle-bracket syntax.
#[test]
fn tsx_jsx_becomes_react_create_element() {
...
/// must be converted to nested `React.createElement` calls.
#[test]
fn tsx_self_closing_element_becomes_create_element() {
